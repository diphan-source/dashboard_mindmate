            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                ...
                <div class="onhover-show-div notification-dropdown">
                  <div class="dropdown-title">
                    <h3>Notification</h3><a class="f-right" href="https://admin.pixelstrap.com/zeta/starter-kit/cart.html"> <i data-feather="bell">                           </i></a>
                  </div>
                  <ul class="custom-scrollbar">
                    <li>
                      <div class="media">
                        ...
                        <div class="notification-right"><a href="footer-dark.html#"><i data-feather="x"></i></a></div>
                      </div>
                    </li>
                    <li> 
                      <div class="media">
                    ...
                    <li class="p-0"><a class="btn btn-primary" href="footer-dark.html#">Check all</a></li>
                  </ul>
                </div>
              </li>
              <li class="maximize"><a class="text-dark" href="footer-dark.html#!" onclick="javascript:toggleFullScreen()">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g> 
                      <g>    
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="https://admin.pixelstrap.com/zeta/starter-kit/user-profile.html"><i data-feather="user"></i><span>Account </span></a></li>
                  <li><a href="https://admin.pixelstrap.com/zeta/starter-kit/email-application.html"><i data-feather="mail"></i><span>Inbox</span></a></li>
                  <li><a href="https://admin.pixelstrap.com/zeta/starter-kit/kanban.html"><i data-feather="file-text"></i><span>Taskboard</span></a></li>
                  <li><a href="https://admin.pixelstrap.com/zeta/starter-kit/edit-profile.html"><i data-feather="settings"></i><span>Settings</span></a></li>
                  <li><a href="https://admin.pixelstrap.com/zeta/starter-kit/login.html"><i data-feather="log-in"> </i><span>Log in</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
